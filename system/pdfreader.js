// FILE: /INSTALLER/APPLICATIONS/pdfreader.js
// VERSION: 1.1.0
// BUILD DATE: 2025-09-22
//
// PDFREADER.JS - PDF DOCUMENT VIEWER APPLICATION
//
// PURPOSE:
...
//
// ARCHITECTURE:
//   - IIFE pattern with window.PDFReaderApp namespace (matches other apps)
...
(function() {
  window.PDFReaderApp = {
    ...
    open() {
        ...
        ">
          ...
          ">
            ...
            ">
              ...
              <h3 style="margin: 0 0 16px 0; color: white;">PDF Reader</h3>
      ...
      const win = window.WindowManager.createWindow('PDF Reader', readerHTML, 700, 500, 'pdfreader');
  ...
  // Register with AppRegistry using the same pattern as other apps
  if (window.AppRegistry) {
    window.AppRegistry.register({
      id: 'pdfreader',
      name: 'PDF Reader',
      ...
      handler: () => window.PDFReaderApp.open(),
      singleInstance: true
    });
  }
})();
